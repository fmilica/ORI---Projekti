...
THE_CHOSEN_MODEL = "X-Ray-CNN-64x4-ThreeDropout-1x0.3-1x0.4-1x0.5-Batch-32-l1-0x001-1xDense-1xDropout-l2-0x001"
...
if __name__ == '__main__':
    ...
    saved_model = load_model(THE_CHOSEN_MODEL + '.model', custom_objects={'f1':f1})

    # evaluacija
    print("THE CHOSEN MODEL - " + THE_CHOSEN_MODEL)
